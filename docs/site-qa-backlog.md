...
### Open
- [ ] **Test a real form submission** — Steve: submit the `/contact/` form once and confirm the notification lands at secretary@mentonehockey.org.au (WPForms sends via PHP mail on LiteSpeed; if it doesn't arrive, an SMTP plugin is the fix).
